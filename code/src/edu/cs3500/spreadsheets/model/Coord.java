...
/**
 * A value type representing coordinates in a {@link Spreadsheet}.
 */
public class Coord {
  ...
  /**
   * The constructor for a Coord.
   * @param col int representing the column, 1-indexed
   * @param row int representing the row, 1-indexed
   */
